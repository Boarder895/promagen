// Admin index with quick links (adds Providers)
    ...
    <main className="space-y-6">
      ...
      <section className="rounded-2xl border p-4">
        <ul className="list-disc pl-6 space-y-2">
          <li><Link className="underline" href="/admin/settings">Settings (HMAC · Meta · Download CSV)</Link></li>
          <li><Link className="underline" href="/admin/providers">Providers (API vs Simulated · Run tests)</Link></li>
          <li><Link className="underline" href="/status">System Status (API health + meta)</Link></li>
        </ul>
      </section>
