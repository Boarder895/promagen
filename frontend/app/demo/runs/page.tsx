...
export default async function Page() {
  ...
  return (
    <main className="space-y-6">
      <h1 className="text-2xl font-semibold">Demo · Generation Progress</h1>
      <p className="opacity-80">
        Click a provider or “Run All”. This uses the simulator to mimic generation delays and updates tile badges.
      </p>
