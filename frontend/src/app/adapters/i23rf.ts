...
// @ts-nocheck
// Minimal Stage-2 adapter stub for 'i23rf'.
...
export function deepLink(_prompt) {
  ...
  return {
    url: "https://www.123rf.com/ai-image-generator/",
    supportsPrefill: false,
    prefilledUrl: "https://www.123rf.com/ai-image-generator/"
  };
}
