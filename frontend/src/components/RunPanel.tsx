 ...
 * This prevents the ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“Event handlers cannot be passed to Client Component propsÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â
...
export default function RunPanel({ initialLabel }: { initialLabel: string }) {
  ...
  function handleClick() {
    ...
    setCount((c) => c + 1);
    setLabel((l) => (l === "Run" ? "RunningÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦" : "Run"));
