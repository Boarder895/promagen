...
// ============================================================================
// MISSION CONTROL - Smart Automated Prompts Panel (v8.0.0)
// ============================================================================
// Right-side panel with weather-driven prompt preview.
//
// v8.0.0 CHANGES (Inspire/Prompt Lab swap):
// - Inspire moved to homepage (/). Prompt Lab moved to /prompt-lab.
// - "Inspire" button replaced by "Prompt Lab" button (href /prompt-lab).
// - Prop renamed: isInspirePage → isPromptLabPage (hide self-link on
//   the Prompt Lab page, replacing it with a Home button).
// - Button grid per page:
//     Homepage (/, Inspire):  Prompt Lab | World Context | Pro        | My Prompts
//     Prompt Lab:             Home       | World Context | Pro        | My Prompts
//     World Context:          Home       | Prompt Lab    | Pro        | My Prompts
//     Pro Promagen:           Home       | Prompt Lab    | World Ctx  | My Prompts
//     Provider / Studio:      Home       | Prompt Lab    | Pro        | My Prompts
//     My Prompts:             Home       | Prompt Lab    | World Ctx  | Pro
//
// v7.0.0 (prev): Inspire button added; /inspire was a separate page.
// v6.0.0 (prev): My Prompts added. v5.0.0: World Context added.
...
export interface MissionControlProps {
  ...
  /** When true, shows Home instead of Prompt Lab button (for /prompt-lab page) */
...
// Prompt Lab / Beaker icon path (Heroicons beaker) — matches mobile-bottom-nav LabIcon
const promptLabIconPath =
  'M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714a2.25 2.25 0 00.659 1.591L19 14.5M14.25 3.104c.251.023.501.05.75.082M5 14.5l-1.456 1.455A2.25 2.25 0 005.13 20h13.74a2.25 2.25 0 001.586-3.845L19 14.5M5 14.5h14';
...
export default function MissionControl({
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // RENDER PROMPT LAB BUTTON — Always links to /prompt-lab
  // ══════════════════════════════════════════════════════════════════════════
  const renderPromptLabButton = () => (
    <a
      href="/prompt-lab"
      className={`${actionButtonBase} ${actionButtonActive}`}
      aria-label="Open the Prompt Lab — build prompts for 40 AI platforms"
      style={{
        padding: 'clamp(0.4rem, 0.5vh, 0.7rem) clamp(0.4rem, 0.5vw, 0.7rem)',
        gap: 'clamp(0.2rem, 0.3vw, 0.4rem)',
        height: 'clamp(40px, 5vh, 60px)',
    ...
    >
      ...
      >
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={promptLabIconPath} />
      </svg>
      <span className="text-purple-100" style={{ fontSize: 'clamp(0.65rem, 0.8vw, 0.85rem)' }}>
        Prompt Lab
      </span>
    </a>
  );
  ...
  // v8.0.0: Always 4-col. 5 possible buttons, each page drops its self-link.
  // Homepage (/, Inspire): Prompt Lab | World Context | Pro | My Prompts
  // Prompt Lab:            Home | World Context | Pro | My Prompts
  // World Context:         Home | Prompt Lab | Pro | My Prompts
  // Pro Promagen:          Home | Prompt Lab | World Context | My Prompts
  // Provider/Studio:       Home | Prompt Lab | Pro | My Prompts
  // My Prompts:            Home | Prompt Lab | World Context | Pro
  // ══════════════════════════════════════════════════════════════════════════
  ...
  return (
    ...
    >
      ...
      {/* ACTION ZONE — 4-col grid (v8.0.0)
           5 buttons total: Home, Prompt Lab, World Context, Pro, My Prompts
      ...
      <div className={`grid ${gridCols}`} style={{ gap: 'clamp(8px, 0.8vw, 12px)' }}>
        {isMyPromptsPage ? (
          // My Prompts page: Home | Prompt Lab | World Context | Pro
          <>
            {renderHomeButton()}
          ...
          // Prompt Lab page: Home | World Context | Pro | My Prompts
          <>
            {renderHomeButton()}
            {renderWorldContextButton()}
            {renderProButton()}
          ...
          // Provider / Studio pages: Home | Prompt Lab | Pro | My Prompts
          <>
            {renderHomeButton()}
            {renderPromptLabButton()}
            {renderProButton()}
          ...
          // Homepage (/, Inspire content): Prompt Lab | World Context | Pro | My Prompts
          <>
            {renderPromptLabButton()}
            {renderWorldContextButton()}
            {renderProButton()}
