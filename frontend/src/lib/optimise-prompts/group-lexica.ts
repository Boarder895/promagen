// src/lib/optimise-prompts/group-lexica.ts
// ============================================================================
// DEDICATED BUILDER: Lexica — Independent CLIP System Prompt
// ============================================================================
// Tier 1 | idealMin 200 | idealMax 350 | tokenLimit 150
// negativeSupport: separate | architecture: clip-based
// supportsWeighting: false
//
// Platform knowledge: Aperture v4 model. Responds well to photographic terms. Front-load camera and le
//
...
export function buildLexicaPrompt(
  _providerId: string,
