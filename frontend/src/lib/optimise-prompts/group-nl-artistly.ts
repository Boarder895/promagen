...
//
// Platform knowledge: Smart Prompt Enhancer auto-expands short inputs into detailed prompts. Keep inpu...
//
...
export function buildArtistlyPrompt(
  ...
  const systemPrompt = `You are an expert prompt optimiser for "Artistly". This platform reads natural language prose only. No weight syntax, no parameter flags, no CLIP tokens. Strip all (term:1.3), term::1.3, --ar, --v, --no, "masterpiece", "8K" from input.
