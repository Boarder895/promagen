// src/lib/optimise-prompts/group-fotor.ts
// ============================================================================
// DEDICATED BUILDER: Fotor — Independent CLIP System Prompt
// ============================================================================
// Tier 1 | idealMin 50 | idealMax 400 | tokenLimit 150
// negativeSupport: separate | architecture: clip-based
// supportsWeighting: true
//
// Platform knowledge: Exposes full SD (term:1.3) weight syntax. Separate negative prompt field. CLIP 7
//
...
export function buildFotorPrompt(
  _providerId: string,
...
Fotor is a consumer design tool that exposes full SD weight syntax. Users may not know what weights are — the prompt must be technically correct but the output is used by non-technical people.
...
6. SWEET SPOT: 50–400 characters. Trim from lowest-priority categories if over.
