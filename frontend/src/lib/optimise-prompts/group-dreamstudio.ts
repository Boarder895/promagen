// src/lib/optimise-prompts/group-dreamstudio.ts
// ============================================================================
// DEDICATED BUILDER: DreamStudio — Independent CLIP System Prompt
// ============================================================================
// Tier 1 | idealMin 200 | idealMax 350 | tokenLimit 150
// negativeSupport: separate | architecture: clip-based
// supportsWeighting: true
//
// Platform knowledge: Stability API wrapper. SD3/Ultra/Core strip parenthetical weights. SDXL supports
//
...
export function buildDreamstudioPrompt(
  _providerId: string,
...
DreamStudio wraps the Stability API. SD3/Ultra/Core models ignore weight syntax — but SDXL supports full (term:weight). Optimise for SDXL syntax as the common denominator.
