// src/lib/optimise-prompts/group-nl-bing.ts
// ============================================================================
// DEDICATED BUILDER: Bing Image Creator — Independent System Prompt
// ============================================================================
// Tier 3 | idealMin 100 | idealMax 300 | maxChars 480 | Strategy: BALANCE
...
// ============================================================================
// COMPLIANCE: Bing Image Creator-specific cleanup
// ============================================================================

function enforceBingCleanup(text: string): ComplianceResult {
  const fixes: string[] = [];
  let cleaned = text;
...
export function buildBingPrompt(
  _providerId: string,
...
Return ONLY valid JSON:
{
  ...
  return {
    systemPrompt,
    groupCompliance: enforceBingCleanup,
  };
}
