// src/lib/optimise-prompts/group-stability.ts
// ============================================================================
// DEDICATED BUILDER: Stability AI — Independent CLIP System Prompt
// ============================================================================
// Tier 1 | idealMin 200 | idealMax 350 | tokenLimit 77
// negativeSupport: separate | architecture: clip-based
// supportsWeighting: true
//
// Platform knowledge: Canonical CLIP platform. 77-token CLIP limit per chunk. Quality boosters essenti
//
...
Stability is the reference CLIP implementation. All weight syntax and quality conventions are defined here first.
