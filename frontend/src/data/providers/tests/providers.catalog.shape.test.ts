...
// Shape tests for providers.json – guards the canonical 45-provider catalogue.
...
describe('providers.catalog.json shape', () => {
  it('has the canonical 45 providers (update intentionally if this changes)', () => {
    expect(Array.isArray(providers)).toBe(true);
    expect(providers.length).toBe(45);
  });
