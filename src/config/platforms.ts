...
export const PLATFORMS_20: Platform[] = [
  { id: "canva",            name: "Canva Text-to-Image",           rank: 1,  kind: "affiliate", markers: ["💸"], notes: "Affiliate-first" },
  { id: "openai",           name: "OpenAI (DALL·E / GPT-Image)",   rank: 2,  kind: "api",       markers: ["⚙️"], notes: "API-ready later" },
  { id: "midjourney",       name: "Midjourney",                    rank: 3,  kind: "ui_only",   markers: ["🌍"], notes: "Discord UI only" },
  { id: "stability",        name: "Stability AI (Stable Diffusion)",rank: 4, kind: "api",       markers: ["⚙️"], notes: "API-ready later" },
  { id: "adobe-firefly",    name: "Adobe Firefly",                 rank: 5,  kind: "affiliate", markers: ["💸"] },
  { id: "bing",             name: "Bing Image Creator",            rank: 6,  kind: "ui_only",   markers: ["🌍"], notes: "Microsoft ecosystem" },
  { id: "leonardo",         name: "Leonardo AI",                   rank: 7,  kind: "api",       markers: ["⚙️","💸"], notes: "API + affiliate" },
  ...
  { id: "picsart",          name: "Picsart",                       rank: 12, kind: "api",       markers: ["⚙️","💸"], notes: "API + affiliate" },
  { id: "ideogram",         name: "Ideogram",                      rank: 13, kind: "affiliate", markers: ["💸"] },
  { id: "bluewillow",       name: "BlueWillow",                    rank: 14, kind: "ui_only",   markers: ["🌍"], notes: "Discord UI" },
  ...
  { id: "flux-schnell",     name: "Flux Schnell",                  rank: 18, kind: "api",       markers: ["⚙️"], notes: "New model family" },
  { id: "artistly",         name: "Artistly",                      rank: 19, kind: "affiliate", markers: ["💸"] },
  { id: "krea",             name: "Krea",                          rank: 20, kind: "affiliate", markers: ["💸"], notes: "Artist programme" },
];
