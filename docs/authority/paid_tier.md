...
- **AI Providers Leaderboard** â€” Browse and compare all 45 AI image generation providers
...
Selection limits are **platform-aware** â€” different AI platforms handle prompt complexity differently. The system assigns each of Promagen's 45 supported platforms to one of four tiers based on their prompt handling capabilities.
...
**Source of truth:** `src/data/platform-tiers.ts` — all 45 providers from `providers.json` are assigned.
...
- All "42 platform" references updated to "45 platforms" across 4 files
