# Promagen Users — Demo Layer & Display Rules

**Last updated:** 9 April 2026
**Version:** 5.0.0 (extracted from promagen-users-master.md v4.0)
**Owner:** Promagen
**Status:** 4 of 5 items signed off by ChatGPT. Item 3 (total range) retuned.
**Note:** The real user system (data flow, events, cron) is documented in `cron_jobs.md` §1. This doc covers the demo layer, display rules, and ChatGPT sign-off items.
...
| Date | Change |
|------|--------|
| 9 Apr 2026 | v5.0.0: Extracted from promagen-users-master.md. Real system docs now in cron_jobs.md §1. |
| 6 Apr 2026 | v4.0 ChatGPT sign-off (4/5 items). |

_Real user system: see `cron_jobs.md` §1. This doc covers demo layer and display rules._
